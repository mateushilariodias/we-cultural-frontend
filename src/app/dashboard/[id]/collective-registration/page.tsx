  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push(`/painel/${artistId}/login-coletivo`);
      } else {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-center mt-6 text-gray-600">
            Já tem um coletivo cadastrado? <a href={`/painel/${artistId}/login-coletivo`} className="text-greenPrimary hover:underline font-semibold">Faça login</a>
          </p>
        </div>
      </div>
    </div>
