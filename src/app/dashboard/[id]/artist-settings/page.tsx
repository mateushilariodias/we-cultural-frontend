    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <a href="/entrar" className="bg-[#1e3a8a] text-white px-6 py-3 rounded hover:bg-[#15306e] transition inline-block">
            Fazer Login
          </a>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-[#1e3a8a] text-white px-4 lg:px-40 py-4">
        <div className="flex items-center gap-4">
          <button onClick={() => router.push(`/painel/${artist?._id || artist?.id}`)} className="hover:opacity-80 transition">
