        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="relative w-16 h-16 rounded-lg bg-purple-100 flex items-center justify-center overflow-hidden">
                {equipment.logo ? (
                  <Image src={equipment.logo} alt="Logo" fill sizes="64px" className="object-cover" />
                ) : (
